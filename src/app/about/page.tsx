...
const page = () => {
  return (
    <div className="text-white mt-20 w-full max-w-6xl mx-auto min-h-screen mb-20">
      <h1 className={`${sofia.className} !mb-0 min-[400px]:text-[80px] text-[60px] sm:text-[80px] md:text-[80px] text-center`}>About <p className={`tracking-wider leading-none !mb-0 font-bold text-gradient inline-block`}>Galaxy<span className='capitalize'>Fi</span></p></h1>   
      <div className='flex flex-col text-center gap-6 mt-10 px-3'>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
          <div className="flex flex-col gap-3 text-center md:text-left justify-center">
            <h1 className={`text-4xl font-bold text-darkViolet ${sofia.className}`}>Our Vision</h1>
            <p className={`${dmsans.className} text-lg`}>
        ...
        <div className="flex flex-col gap-3">
          <h1 className={`text-4xl font-bold text-darkViolet !mt-16 ${sofia.className}`}>Why GalaxyFi</h1>
          <p className={`${dmsans.className} text-lg`}>
