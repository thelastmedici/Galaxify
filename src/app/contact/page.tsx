        ...
        <div className='w-full grid grid-cols-2 gap-4'>
          <div className='flex flex-row gap-4'>
            ...
            <div className='flex flex-col'>
              <h2 className={`${inter.className} font-bold text-lg`}>Phone</h2>
          ...
          <div className='flex flex-row gap-3'>
            ...
            <div className='flex flex-col'>
              <h2 className={`${inter.className} font-bold text-lg`}>Email</h2>
          ...
          <div className='flex flex-row gap-3'>
            ...
            <div className='flex flex-col'>
              <h2 className={`${inter.className} font-bold text-lg`}>Instagram</h2>
          ...
          <div className='flex flex-row gap-3'>
            ...
            <div className='flex flex-col'>
              <h2 className={`${inter.className} font-bold text-lg`}>Facebook</h2>
          ...
          <div className='flex flex-row gap-3'>
            ...
            <div className='flex flex-col'>
              <h2 className={`${inter.className} font-bold text-lg`}>X</h2>
          ...
          <div className='flex flex-row gap-3'>
            ...
            <div className='flex flex-col'>
              <h2 className={`${inter.className} font-bold text-lg`}>LinkedIn</h2>
